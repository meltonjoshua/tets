...
import { Plus, Flower2 } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <EmptyState
          title="No plants yet"
          message="Add your plants to track watering, fertilizing, and care schedules."
          icon={<Flower2 size={48} color={Colors.gray[300]} />}
        />
      </View>
    </View>
  );
